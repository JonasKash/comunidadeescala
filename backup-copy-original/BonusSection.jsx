  ...
  const bonuses = [
    {
      ...
      description: 'Um atalho para conseguir resultado rápido no mercado.',
      features: [
        'Ajuda contínua',
        'Aulas da estruturação completa da operação',
    ...
    },
    {
      ...
      description: 'Acelere seu processo com ferramentas que automatizam processos',
      features: [
        'Aprender criar seu bot automatizado',
        'Gerar homens pagantes para esse bot',
        'Aprender a gerar nome no pix de mulheres.'
      ],
      price: 'R$ 147',
      crossedOut: true
    }
